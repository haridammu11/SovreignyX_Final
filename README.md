...
sequenceDiagram
    participant User as 👤 Initiate
    participant Scion_Core as ⚡ Core
    participant Neural_Engine as 🧠 Brain
    participant Groq_LLM as 🤖 Llama-3
    participant Content_Grid as 📦 Grid
...
sequenceDiagram
    participant Candidate as 🎯 Subject
    participant Device_Sensors as 📷 Input
    participant Scion_Client as 📱 Terminal
    participant Sentinel_AI as 👁️ Sentinel
    participant Sovereign_Command as 🏢 HQ
...
<div style="display: flex; justify-content: Left; gap: 16px; flex-wrap: wrap;">
    <h3>Scion Dashboard</h3>
  <img src="./dashboard_architecture_professional.png" height="1000" width="600" alt="dashboard architecture professional" />
    
  <img src="course_detail_architecture_professional.png" height="1000" width="600" alt="scion snapshot" />
